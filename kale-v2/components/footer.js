...
export default function Footer() {
    ...
    return (
        <div className="fixed bottom-0 font-mono">
            <div>
          <IconButton size="medium" href={"https://github.com/kalefed"} target="_blank" rel="noopener" style={{ color: "#759dc5"}}>
            <GitHubIcon fontSize="medium"/>
          </IconButton>
          <IconButton size="medium" href={"https://www.linkedin.com/in/kaleighfeder/"} target="_blank" rel="noopener" style={{ color: "#759dc5"}}>
            <LinkedInIcon fontSize="medium"/>
          </IconButton>
          <IconButton size="medium" href={generateEmailLink()} target="_blank" rel="noopener" style={{ color: "#759dc5"}}>
