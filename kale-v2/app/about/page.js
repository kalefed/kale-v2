    ...
    <div className="h-[calc(100vh-65px)]">
      <div className="flex flex-col lg:flex-row items-center h-full">
        ...
        <div className="basis-1/2">
          ...
          <p className={`lg:text-base md:text-md text-sm ${dm_mono.className}`}>
            ...
            <br />
            <br />
            In my free time, you can find me reading a book, usually fantasy or
            sci-fi, playing Breath of the Wild, or drawing.
          </p>
        </div>
      </div>
    </div>
